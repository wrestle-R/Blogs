...
<div class="vpssh-theme-image">
  <img class="vpssh-russia-light" src="/blogimages/vpSSH/Russia_light.png" alt="SSH login attempts from IP addresses around the world shown on a light map" />
  <img class="vpssh-russia-dark" src="/blogimages/vpSSH/Russia_dark.png" alt="SSH login attempts from IP addresses around the world shown on a dark map" />
</div>
...
<style is:global>{`
  ...
  .vpssh-theme-image .vpssh-russia-dark {
    display: none;
  }

  [data-theme='dark'] .vpssh-theme-image .vpssh-intro-light,
  [data-theme='dark'] .vpssh-theme-image .vpssh-russia-light {
    display: none;
  }

  [data-theme='dark'] .vpssh-theme-image .vpssh-intro-dark,
  [data-theme='dark'] .vpssh-theme-image .vpssh-russia-dark {
    display: block;
  }
